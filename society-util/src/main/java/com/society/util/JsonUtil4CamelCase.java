...
public class JsonUtil4CamelCase {
	...
	public static String toJson(Object obj) {
		...
		try {
			...
			throw new JsonConvertRuntimeException("obj[" + obj + "]转换出错 ");
		}
		return json;
	}
	...
	public static <T> T toObject(String json, Class<T> cls) {
		...
		try {
			...
			throw new JsonConvertRuntimeException("toObject:json[" + json + "]转换出错 class[" + cls + "]");
		}
		return result;
	}
	...
	public static <T> T toObject(InputStream in, Class<T> cls) {
		...
		try {
			...
			throw new JsonConvertRuntimeException("转换出错 class[" + cls + "]");
		}
		return result;
	}
	...
	public static void write(OutputStream out, Object value) {
		try {
			...
			throw new JsonConvertRuntimeException("转换出错 value[" + value + "]");
		}
	}
	...
	public static <T> T toObject(String json, TypeReference<T> typeReference) {
		...
		try {
			...
			e.printStackTrace();
			throw new JsonConvertRuntimeException("toObject:json[" + json + "]转换出错 typeReference[" + typeReference + "]");
		}
		return result;
	}
	...
	public static <T> List<T> toListObject(String json, Class<T> cls) {
		...
		try {
			...
			throw new JsonConvertRuntimeException("toListObject:json[" + json + "]转换出错 class[" + cls + "]");
		}
		return result;
	}
	...
	public static Map toMap(String json) {
		...
		try {
			...
			throw new JsonConvertRuntimeException("toMap:json[" + json + "]转换出错");
		}
		return result;
	}
	...
	public static Map<String, Object>[] toArray(String json) {
		...
		try {
			...
			throw new JsonConvertRuntimeException("toArray:json[" + json + "]转换出错");
		}
		return result;
	}
}
